package PracticalCloudester.resources;
...
public class BaseCloudester 
{
	...
	{
		prop = new Properties();
		FileInputStream fip = new FileInputStream("E:\\Automation Projects\\PracticalCloudester\\Data.Properties");
		prop.load(fip);
